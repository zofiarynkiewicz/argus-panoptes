...
export const BlackDuckChecks: DynamicThresholdCheck[] = [
  { // BlackDuck critical security risk check
    ...
    annotationKeyThreshold: 'tech-insights.io/blackduck-critical-security-risk-threshold',
    annotationKeyOperator: 'tech-insights.io/blackduck-critical-security-risk-operator',
  ...
  { // BlackDuck high security risk check
    ...
    annotationKeyThreshold: 'tech-insights.io/blackduck-high-security-risk-threshold',
    annotationKeyOperator: 'tech-insights.io/blackduck-high-security-risk-operator',
  ...
  { // BlackDuck medium security risk check
    ...
    annotationKeyThreshold: 'tech-insights.io/blackduck-medium-security-risk-threshold',
    annotationKeyOperator: 'tech-insights.io/blackduck-medium-security-risk-operator',
