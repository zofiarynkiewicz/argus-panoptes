...
// List TODOs:
//
//   curl http://localhost:7007/api/ai-plugin/todos
//
// Explicitly make an unauthenticated request, or with service auth:
//
//   curl http://localhost:7007/api/ai-plugin/todos -H 'Authorization: Bearer mock-none-token'
//   curl http://localhost:7007/api/ai-plugin/todos -H 'Authorization: Bearer mock-service-token'
